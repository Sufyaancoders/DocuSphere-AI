...
const VerificationPage = () => {
  ...
  // Prefer Redux, fallback to localStorage, but warn if sensitive data is in localStorage
  let signupData = useSelector((state) => state.auth.signupData);
  if (!signupData) {
      ...
      try {
        ...
        const signupPromise = dispatch(
          signUp(
            ...
            confirmPassword,
            otp,
           // Ensure contactNumber is included
            navigate
          )
        );
